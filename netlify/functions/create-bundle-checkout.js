exports.handler = async function (event) {
  ...
  const priceId   = process.env.BUNDLE_PRICE_ID;
  if (!priceId) return { statusCode: 500, body: 'BUNDLE_PRICE_ID not configured' };
  const response = await fetch('https://api.stripe.com/v1/checkout/sessions', {
    ...
    body: new URLSearchParams({
      ...
      'success_url':             'https://stellara-horoscope.com/?bundle=true',
